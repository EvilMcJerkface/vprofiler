...
def collect_exec_time(function_file, path):
    ...
    latencyAggregator = LatencyAggregator(path + "OperationLog.log")
    function_exec_time = latencyAggregator.GetLatencies(path + "SynchronizationTimeLog.log", len(function_names))
#    function_exec_time = []
