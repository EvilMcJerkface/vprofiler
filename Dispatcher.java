...
public class Dispatcher {
    ...
    private Dispatcher(String _sourceFilePath, String _execScriptPath, 
                       ...
                       String _dataDir, String _heightsFile, Integer _numFactors) {
    ...
    public void Run() throws Exception {
        ...
        pb.command("factor_selector.sh", topLvlFunc, dataDir, heightsFile, Integer.toString(numFactors), topLvlFunc);
    ...
    public static Dispatcher NewDispatcher(CommandLine cmd) {
        ...
        failure = Utils.AnyNull(sourceFile, execScript, compScript, 
                                topLvlFunc, dataDir, heightPath, preFactors);
        ...
        return new Dispatcher(sourceFile, execScript, compScript, 
                              topLvlFunc, dataDir, heightPath, numFactors);
    }
}
